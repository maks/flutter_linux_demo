/// ref: https://stackoverflow.com/a/70694463/85472
...
class MockHttpOverrides extends HttpOverrides {
  ...
  HttpClient createHttpClient(SecurityContext? context) {
    ...
    when(() => response.contentLength).thenAnswer((_) => data[response.requestedUrl]!.length);
...
class MockHttpClientResponse extends Mock implements HttpClientResponse {
  ...
  Future<S> fold<S>(
    ...
    return Stream.fromIterable([data[requestedUrl]]).fold(initialValue, combine as S Function(S, List<int>?));
  }
}
